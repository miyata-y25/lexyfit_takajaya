...
define('SUBJECT', '【レクシーフィット高茶屋店】お問い合わせありがとうございます。');
define('SUBJECT_PRO', '【重要】ホームページよりお問い合わせがありました');
define('TO_ADDR', 'lexyfit.takajaya@gmail.com');

define('FROM_NAME', 'レクシーフィット');

define('FROM_ADDR', 'lexyfit.takajaya@gmail.com');
